...
class NolimitholdemGame(Game):
    def __init__(self, allow_step_back=False, num_players=2):
        ...
        self.players = None
        self.policy = 'random'
        self.last_raiser_preflop = -3
        self.last_raiser_flop = -1
        self.last_raiser_turn = -1
        self.last_raiser_river = -1
    ...
    def get_state(self, player_id):
        ...
        state['opponent_last_action'] = self.round.get_last_action((player_id + 1) % self.num_players)
        return state
