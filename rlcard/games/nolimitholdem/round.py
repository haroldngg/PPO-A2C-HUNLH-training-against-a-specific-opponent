...
class NolimitholdemRound:
    ...
    def proceed_round(self, players, action):
        ...
        self.last_actions[self.game_pointer] = action
    ...
    def get_last_action(self, player_id):

        return self.last_actions.get(player_id, Action.CHECK_CALL)
